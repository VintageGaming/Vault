  ...
  public class PermissionServerListener
    ...
    public void onPluginEnable(PluginEnableEvent event) {
      if (Chat_mChatSuite.this.mChat == null) {
        ...
        if (chat.getDescription().getName().equals("mChatSuite")) {
          ...
          Chat_mChatSuite.this.log.info(String.format("[%s][Chat] %s hooked.", plugin.getDescription().getName(), "mChatSuite"));
        } 
      } 
    }
    ...
    public void onPluginDisable(PluginDisableEvent event) {
      if (Chat_mChatSuite.this.mChat != null && 
        ...
        Chat_mChatSuite.this.log.info(String.format("[%s][Chat] %s un-hooked.", plugin.getDescription().getName(), "mChatSuite"));
      } 
    }
  }

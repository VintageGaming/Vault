  ...
  public Chat_iChat(Plugin plugin, Permission perms) {
    ...
    if (this.iChat == null) {
      ...
      if (chat != null) {
        ...
        this.log.info(String.format("[%s][Chat] %s hooked.", new Object[] { plugin.getDescription().getName(), "iChat" }));
      } 
    } 
  }
  ...
  public class PermissionServerListener implements Listener {
    ...
    public void onPluginEnable(PluginEnableEvent event) {
      if (this.chat.iChat == null) {
        ...
        if (chat.getDescription().getName().equals("iChat")) {
          ...
          Chat_iChat.this.log.info(String.format("[%s][Chat] %s hooked.", plugin.getDescription().getName(), "iChat"));
        } 
      } 
    }
    ...
    public void onPluginDisable(PluginDisableEvent event) {
      if (this.chat.iChat != null && 
        ...
        Chat_iChat.this.log.info(String.format("[%s][Chat] %s un-hooked.", plugin.getDescription().getName(), "iChat"));
      } 
    }
  }

  ...
  extends AbstractEconomy
{
  ...
  public Economy_CommandsEX(Plugin plugin) {
     ...
     if (this.economy == null) {
       ...
       if (commandsex != null && commandsex.isEnabled()) {
         ...
         this.log.info(String.format("[Economy] %s hooked.", new Object[] { "CommandsEX Economy" }));
      } 
    } 
  }
  ...
  public class EconomyServerListener implements Listener {
    ...
    public void onPluginEnable(PluginEnableEvent event) {
       if (this.economy.economy == null) {
         ...
         if (cex.getDescription().getName().equals("CommandsEX")) {
           ...
           Economy_CommandsEX.this.log.info(String.format("[Economy] %s hooked.", new Object[] { "CommandsEX Economy" }));
        } 
      } 
    }
    ...
    public void onPluginDisable(PluginDisableEvent event) {
       if (this.economy.economy != null && 
         event.getPlugin().getDescription().getName().equals("CommandsEX")) {
         this.economy.economy = null;
         Economy_CommandsEX.this.log.info(String.format("[Economy] %s unhooked.", new Object[] { "CommandsEX Economy" }));
      } 
    }
  }
